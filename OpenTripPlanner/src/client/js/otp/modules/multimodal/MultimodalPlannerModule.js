...
otp.modules.multimodal.MultimodalPlannerModule =
    ...
    activate : function() {
        ...
        // Nasconde dall'interfaccia il selettore delle rotte bannate; di default è nascosto
        if(otp.config.showBannedRoutes === undefined || otp.config.showBannedRoutes === true) {
    ...
    processPlan : function(tripPlan, restoring, append=false) {
