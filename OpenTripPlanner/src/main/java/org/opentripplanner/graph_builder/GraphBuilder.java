...
import org.opentripplanner.ext.greenrouting.GreenStreetEdgeFactory;
...
public class GraphBuilder implements Runnable {
    ...
    public static GraphBuilder create(
        ...
        DefaultStreetEdgeFactory streetEdgeFactory;
        if (OTPFeature.GreenRouting.isOn())
            streetEdgeFactory = new GreenStreetEdgeFactory();
        else
            streetEdgeFactory = new DefaultStreetEdgeFactory();
